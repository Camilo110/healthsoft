...
<body class="bg-dark d-flex justify-content-center align-items-center vh-100">
    <form action = "aportesBack.php" method = "POST" id="formAportes">
        <div class="bg-shadow p-5 rounded-5 text-secondary shadow" style="width: 30rem">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-15">
                    <input class="form-control bg-light" name="valorPago" type="text" placeholder="2001233" id="ValorPago" />
                </div>
            </div>
            <div class="form-group row">
                <label class=" col-form-label fw-bold" style="font-size: 1.1rem">DNI del Cotizante</label>
                <div class="col-sm-15">
                    <input class="form-control bg-light" name="idCotizante" type="text" placeholder="1006252932" id="idCotizante" />
                </div>
            </div>
            <div class="form-group row">
                <label class=" col-form-label fw-bold" style="font-size: 1.1rem">NIT de Empresa</label>
                <div class="col-sm-15">
                    <input class="form-control bg-light" name="codEmpresa" type="text" placeholder="5678" id="codEmpresa" />
                </div>
            </div>
