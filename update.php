                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-15">
                            <input class="form-control bg-light bg-dark" name="estadoAfi" type="text"
                                placeholder="Ingrese Estado de afiliado" id="codigo" value="<?php echo $row['estadoafiliado']  ?>">
                        </div>
                        ...
                        <div class="col-sm-15">
                            <input class="form-control bg-light bg-dark" name="ranSal" type="text"
                                placeholder="Ingrese Rango salarial" id="codigo" value="<?php echo $row['rangosalarial']  ?>">
                        </div>
